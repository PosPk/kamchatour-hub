...
Единый хаб для туриста на Камчатке: поиск → бронирование → оплата → билеты; безопасность, контент и партнёрства.

• Demo Script: см. `docs/DEMO.md`

• 2 Slides (инвестору): см. `docs/SLIDES.md`
